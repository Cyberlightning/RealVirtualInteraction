...
public class UdpSocket implements Runnable  {
  ...
  public void run() {
    ...
    while(true) {
      ...
      String receivedData_decrypted = null;
      
      try {
          receivedData_decrypted = Gzip.decompress(receivedPacket.getData());
           } catch (IOException e) {
                      // TODO Auto-generated catch block
                      e.printStackTrace();
           }
      System.out.println("PACKET AT LEAST RECEIVED: " +receivedData_decrypted);
